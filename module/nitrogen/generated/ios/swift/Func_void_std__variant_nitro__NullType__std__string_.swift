...
/**
 * Wraps a Swift `(_ value: UserComModuleRegisterUserResponse) -> Void` as a class.
...
public final class Func_void_std__variant_nitro__NullType__std__string_ {
  ...
  private let closure: (_ value: UserComModuleRegisterUserResponse) -> Void

  public init(_ closure: @escaping (_ value: UserComModuleRegisterUserResponse) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(value: bridge.std__variant_nitro__NullType__std__string_) -> Void {
    self.closure({ () -> UserComModuleRegisterUserResponse in
      let __variant = value
